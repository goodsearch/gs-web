...
describe("HeroBlock component", function() {
  ...
  it("assigns data.heading to a <h1> tag", function() {
  ...
  it("assigns data.headingCopy to a <p> tag", function() {
    this.component = t.utils.renderIntoDocument(<HeroBlock data={blockData}  />);
  ...
  it("assigns data.ctaTarget to an <a> tag's href", function() {
    this.component = t.utils.renderIntoDocument(<HeroBlock data={blockData}  />);
  ...
  it("assigns data.ctaCopy to an <a> tag's content", function() {
    this.component = t.utils.renderIntoDocument(<HeroBlock data={blockData}  />);
    var a = t.utils.findRenderedDOMComponentWithTag(this.component, "a");
  ...
  describe("when given an asset prefix", function() {
    it("prepends the asset prefix to data.bgImageSrc", function() {
      var prefix = "/prefix";
